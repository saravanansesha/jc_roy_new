...
let Add_instrument_Condition = (props) =>{
    ...
    return(
        <>
        <Modal
            title="Add Instrument Condition"
            footer={false}
            visible={isvisible}
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`instrument_Condition`}>
...
export default Add_instrument_Condition;