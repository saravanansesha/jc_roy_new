...
// import BreadCrumb from "../../machine_Locations/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_machine_Location from "./Add_machine_Location"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Machine_Location = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      machine_Location: 'machine_Locationss1',
      status: 'inactive',
    ...
    {
      key: '2',
      machine_Location: 'machine_Locationss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      machine_Location: 'machine_Locationss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      machine_Location: 'machine_Locationss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      machine_Location: 'machine_Locationss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      machine_Location: 'machine_Locationss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`machine_Location${index}`] = value1[0].machine_Location
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.machine_Location = values[`machine_Location${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`machine_Location${index}`}>
...
<Add_machine_Location setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Machine_Location;
