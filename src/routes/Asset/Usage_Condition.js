...
// import BreadCrumb from "../../usage_Conditions/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_usage_Condition from "./Add_usage_Condition"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Usage_Condition = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      usage_Condition: 'usage_Conditionss1',
      status: 'inactive',
    ...
    {
      key: '2',
      usage_Condition: 'usage_Conditionss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      usage_Condition: 'usage_Conditionss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      usage_Condition: 'usage_Conditionss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      usage_Condition: 'usage_Conditionss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      usage_Condition: 'usage_Conditionss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`usage_Condition${index}`] = value1[0].usage_Condition
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.usage_Condition = values[`usage_Condition${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`usage_Condition${index}`}>
...
<Add_usage_Condition setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Usage_Condition;
