...
// import BreadCrumb from "../../type_of_Maintenances/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_type_of_Maintenance from "./Add_type_of_Maintenance"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Type_of_Maintenance = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      type_of_Maintenance: 'type_of_Maintenancess1',
      status: 'inactive',
    ...
    {
      key: '2',
      type_of_Maintenance: 'type_of_Maintenancess2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      type_of_Maintenance: 'type_of_Maintenancess3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      type_of_Maintenance: 'type_of_Maintenancess4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      type_of_Maintenance: 'type_of_Maintenancess5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      type_of_Maintenance: 'type_of_Maintenancess6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`type_of_Maintenance${index}`] = value1[0].type_of_Maintenance
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.type_of_Maintenance = values[`type_of_Maintenance${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`type_of_Maintenance${index}`}>
...
<Add_type_of_Maintenance setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Type_of_Maintenance;
