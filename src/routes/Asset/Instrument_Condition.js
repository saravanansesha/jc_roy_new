...
// import BreadCrumb from "../../instrument_Conditions/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_instrument_Condition from "./Add_instrument_Condition"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Instrument_Condition = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      instrument_Condition: 'instrument_Conditionss1',
      status: 'inactive',
    ...
    {
      key: '2',
      instrument_Condition: 'instrument_Conditionss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      instrument_Condition: 'instrument_Conditionss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      instrument_Condition: 'instrument_Conditionss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      instrument_Condition: 'instrument_Conditionss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      instrument_Condition: 'instrument_Conditionss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'instrument_Condition',
      key: 'instrument_Condition',
      ...
      if(check_presence.length > 0){
        ...
        values[`instrument_Condition${index}`] = value1[0].instrument_Condition
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.instrument_Condition = values[`instrument_Condition${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`instrument_Condition${index}`}>
...
<Add_instrument_Condition setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Instrument_Condition;
