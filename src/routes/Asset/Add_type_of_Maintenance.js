...
let Add_type_of_Maintenance = (props) =>{
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`type_of_Maintenance`}>
...
export default Add_type_of_Maintenance;