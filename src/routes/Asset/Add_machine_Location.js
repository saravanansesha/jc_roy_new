...
let Add_machine_Location = (props) =>{
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`machine_Location`}>
...
export default Add_machine_Location;