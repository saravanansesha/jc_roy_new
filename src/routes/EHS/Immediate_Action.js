...
// import BreadCrumb from "../../immediate_Actions/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_immediate_Action from "./Add_immediate_Action"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Immediate_Action = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      immediate_Action: 'immediate_Actionss1',
      status: 'inactive',
    ...
    {
      key: '2',
      immediate_Action: 'immediate_Actionss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      immediate_Action: 'immediate_Actionss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      immediate_Action: 'immediate_Actionss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      immediate_Action: 'immediate_Actionss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      immediate_Action: 'immediate_Actionss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`immediate_Action${index}`] = value1[0].immediate_Action
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.immediate_Action = values[`immediate_Action${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`immediate_Action${index}`}>
...
<Add_immediate_Action setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Immediate_Action;
