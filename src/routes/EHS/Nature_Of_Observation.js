...
// import BreadCrumb from "../../nature_Of_Observations/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_nature_Of_Observation from "./Add_nature_Of_Observation"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Nature_Of_Observation = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      nature_Of_Observation: 'nature_Of_Observationss1',
      status: 'inactive',
    ...
    {
      key: '2',
      nature_Of_Observation: 'nature_Of_Observationss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      nature_Of_Observation: 'nature_Of_Observationss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      nature_Of_Observation: 'nature_Of_Observationss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      nature_Of_Observation: 'nature_Of_Observationss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      nature_Of_Observation: 'nature_Of_Observationss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'nature_Of_Observation',
      key: 'nature_Of_Observation',
      ...
      if(check_presence.length > 0){
        ...
        values[`nature_Of_Observation${index}`] = value1[0].nature_Of_Observation
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.nature_Of_Observation = values[`nature_Of_Observation${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`nature_Of_Observation${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          nature_Of_Observation : item.nature_Of_Observation,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_nature_Of_Observation setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Nature_Of_Observation;
