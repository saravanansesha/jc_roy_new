...
// import BreadCrumb from "../../audit_Standardss/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_audit_Standards from "./Add_audit_Standards"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Audit_Standards = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      audit_Standards: 'audit_Standardsss1',
      status: 'inactive',
    ...
    {
      key: '2',
      audit_Standards: 'audit_Standardsss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      audit_Standards: 'audit_Standardsss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      audit_Standards: 'audit_Standardsss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      audit_Standards: 'audit_Standardsss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      audit_Standards: 'audit_Standardsss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`audit_Standards${index}`] = value1[0].audit_Standards
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.audit_Standards = values[`audit_Standards${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`audit_Standards${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          audit_Standards : item.audit_Standards,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_audit_Standards setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Audit_Standards;
