...
// import BreadCrumb from "../../audit_Coordinatorss/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_audit_Coordinators from "./Add_audit_Coordinators"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Audit_Coordinators = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      audit_Coordinators: 'audit_Coordinatorsss1',
      status: 'inactive',
    ...
    {
      key: '2',
      audit_Coordinators: 'audit_Coordinatorsss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      audit_Coordinators: 'audit_Coordinatorsss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      audit_Coordinators: 'audit_Coordinatorsss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      audit_Coordinators: 'audit_Coordinatorsss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      audit_Coordinators: 'audit_Coordinatorsss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'audit_Coordinators',
      key: 'audit_Coordinators',
      ...
      if(check_presence.length > 0){
        ...
        values[`audit_Coordinators${index}`] = value1[0].audit_Coordinators
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.audit_Coordinators = values[`audit_Coordinators${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`audit_Coordinators${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          audit_Coordinators : item.audit_Coordinators,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_audit_Coordinators setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Audit_Coordinators;
