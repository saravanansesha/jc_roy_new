...
// import BreadCrumb from "../../findings_Types/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_findings_Type from "./Add_findings_Type"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Findings_Type = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      findings_Type: 'findings_Typess1',
      status: 'inactive',
    ...
    {
      key: '2',
      findings_Type: 'findings_Typess2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      findings_Type: 'findings_Typess3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      findings_Type: 'findings_Typess4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      findings_Type: 'findings_Typess5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      findings_Type: 'findings_Typess6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`findings_Type${index}`] = value1[0].findings_Type
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.findings_Type = values[`findings_Type${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`findings_Type${index}`}>
...
<Add_findings_Type setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Findings_Type;
