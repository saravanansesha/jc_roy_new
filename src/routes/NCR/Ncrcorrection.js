...
// import BreadCrumb from "../../ncrcorrections/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_ncrcorrection from "./Add_ncrcorrection"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Ncrcorrection = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      ncrcorrection: 'ncrcorrectionss1',
      status: 'inactive',
    ...
    {
      key: '2',
      ncrcorrection: 'ncrcorrectionss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      ncrcorrection: 'ncrcorrectionss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      ncrcorrection: 'ncrcorrectionss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      ncrcorrection: 'ncrcorrectionss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      ncrcorrection: 'ncrcorrectionss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`ncrcorrection${index}`] = value1[0].ncrcorrection
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.ncrcorrection = values[`ncrcorrection${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`ncrcorrection${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          ncrcorrection : item.ncrcorrection,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_ncrcorrection setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Ncrcorrection;
