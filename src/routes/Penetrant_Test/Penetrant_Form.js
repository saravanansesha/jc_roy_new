...
// import BreadCrumb from "../../penetrant_Forms/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_penetrant_Form from "./Add_penetrant_Form"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Penetrant_Form = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      penetrant_Form: 'penetrant_Formss1',
      status: 'inactive',
    ...
    {
      key: '2',
      penetrant_Form: 'penetrant_Formss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      penetrant_Form: 'penetrant_Formss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      penetrant_Form: 'penetrant_Formss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      penetrant_Form: 'penetrant_Formss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      penetrant_Form: 'penetrant_Formss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`penetrant_Form${index}`] = value1[0].penetrant_Form
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.penetrant_Form = values[`penetrant_Form${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`penetrant_Form${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          penetrant_Form : item.penetrant_Form,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_penetrant_Form setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Penetrant_Form;
