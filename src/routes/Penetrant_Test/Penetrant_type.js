...
// import BreadCrumb from "../../penetrant_types/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_penetrant_type from "./Add_penetrant_type"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Penetrant_type = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      penetrant_type: 'penetrant_typess1',
      status: 'inactive',
    ...
    {
      key: '2',
      penetrant_type: 'penetrant_typess2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      penetrant_type: 'penetrant_typess3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      penetrant_type: 'penetrant_typess4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      penetrant_type: 'penetrant_typess5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      penetrant_type: 'penetrant_typess6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`penetrant_type${index}`] = value1[0].penetrant_type
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.penetrant_type = values[`penetrant_type${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`penetrant_type${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          penetrant_type : item.penetrant_type,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_penetrant_type setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Penetrant_type;
