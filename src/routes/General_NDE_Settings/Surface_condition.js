...
// import BreadCrumb from "../../surface_conditions/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_Surface_condition from "./Add_Surface_condition"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Surface_condition = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      surface_condition: 'surface_conditionss1',
      status: 'inactive',
    ...
    {
      key: '2',
      surface_condition: 'surface_conditionss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      surface_condition: 'surface_conditionss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      surface_condition: 'surface_conditionss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      surface_condition: 'surface_conditionss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      surface_condition: 'surface_conditionss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`surface_condition${index}`] = value1[0].surface_condition
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.surface_condition = values[`surface_condition${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`surface_condition${index}`}>
...
<Add_Surface_condition setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Surface_condition;
