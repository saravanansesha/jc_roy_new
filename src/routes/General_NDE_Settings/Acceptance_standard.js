...
// import BreadCrumb from "../../acceptance_standards/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_Acceptance_standard from "./Add_Acceptance_standard"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Acceptance_standard = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      acceptance_standard: 'acceptance_standardss1',
      status: 'inactive',
    ...
    {
      key: '2',
      acceptance_standard: 'acceptance_standardss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      acceptance_standard: 'acceptance_standardss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      acceptance_standard: 'acceptance_standardss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      acceptance_standard: 'acceptance_standardss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      acceptance_standard: 'acceptance_standardss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`acceptance_standard${index}`] = value1[0].acceptance_standard
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.acceptance_standard = values[`acceptance_standard${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`acceptance_standard${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          acceptance_standard : item.acceptance_standard,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_Acceptance_standard setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Acceptance_standard;
