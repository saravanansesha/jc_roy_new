...
// import BreadCrumb from "../../qualifications/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_qualification from "./Add_qualification"
...
const Qualification = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      qualification: 'qualificationss1',
      status: 'inactive',
    ...
    {
      key: '2',
      qualification: 'qualificationss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      qualification: 'qualificationss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      qualification: 'qualificationss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      qualification: 'qualificationss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      qualification: 'qualificationss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`qualification${index}`] = value1[0].qualification
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.qualification = values[`qualification${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`qualification${index}`}>
...
<Add_qualification setvisible={setvisible} isvisible={isvisible} />
