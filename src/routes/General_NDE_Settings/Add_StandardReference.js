...
let Add_StandardReference = (props) =>{
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`StandardReference`}>
...
export default Add_StandardReference;