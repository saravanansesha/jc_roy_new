...
// import BreadCrumb from "../../extend_of_examinations/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_extend_of_examination from "./Add_extend_of_examination"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Extend_of_examination = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      extend_of_examination: 'extend_of_examinationss1',
      status: 'inactive',
    ...
    {
      key: '2',
      extend_of_examination: 'extend_of_examinationss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      extend_of_examination: 'extend_of_examinationss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      extend_of_examination: 'extend_of_examinationss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      extend_of_examination: 'extend_of_examinationss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      extend_of_examination: 'extend_of_examinationss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'extend_of_examination',
      key: 'extend_of_examination',
      ...
      if(check_presence.length > 0){
        ...
        values[`extend_of_examination${index}`] = value1[0].extend_of_examination
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.extend_of_examination = values[`extend_of_examination${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`extend_of_examination${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          extend_of_examination : item.extend_of_examination,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_extend_of_examination setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Extend_of_examination;
