...
// import BreadCrumb from "../../standardQualifieds/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_standardQualified from "./Add_standardQualified"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const StandardQualified = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      standardQualified: 'standardQualifiedss1',
      status: 'inactive',
    ...
    {
      key: '2',
      standardQualified: 'standardQualifiedss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      standardQualified: 'standardQualifiedss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      standardQualified: 'standardQualifiedss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      standardQualified: 'standardQualifiedss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      standardQualified: 'standardQualifiedss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'standardQualified',
      key: 'standardQualified',
      ...
      if(check_presence.length > 0){
        ...
        values[`standardQualified${index}`] = value1[0].standardQualified
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.standardQualified = values[`standardQualified${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`standardQualified${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          standardQualified : item.standardQualified,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_standardQualified setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default StandardQualified;
