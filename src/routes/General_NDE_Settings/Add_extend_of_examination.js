...
let Add_extend_of_examination = (props) =>{
    ...
    return(
        <>
        <Modal
            title="Add Extend of Examination"
            footer={false}
            visible={isvisible}
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`extend_of_examination`}>
...
export default Add_extend_of_examination;