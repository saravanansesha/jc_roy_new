...
let Add_Acceptance_standard = (props) =>{
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`Acceptance_standard`}>
...
export default Add_Acceptance_standard;
