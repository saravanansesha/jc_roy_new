...
let Add_testing = (props) =>{
    ...
    return(
        <>
        <Modal
            title="Add Special Testing Standard"
            footer={false}
            visible={isvisible}
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Special Testing Standard!\'}' }]} name={`special_testing_standard`}>

            <Input placeholder="Special Testing Standard"/>
    </FormItem>
