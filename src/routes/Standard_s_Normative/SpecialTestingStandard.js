...
import Add_special_testing from "./Add_special_testing"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const SpecialTestingStandard = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      special_testing_standard: 'Test1',
      status: 'inactive',
    ...
    {
      key: '2',
      special_testing_standard: 'Test2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      special_testing_standard: 'Test3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      special_testing_standard: 'Test4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      special_testing_standard: 'Test5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      special_testing_standard: 'Test6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Special Testing Standard',
      dataIndex: 'special_testing_standard',
      key: 'special_testing_standard',
      ...
      if(check_presence.length > 0){
        ...
        values[`special_testing_standard${index}`] = value1[0].special_testing_standard
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.special_testing_standard = values[`special_testing_standard${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Testing Standard`} rules={[{ required: true, message: 'Please input your Testing Standard!\'}' }]} name={`special_testing_standard${index}`}>

<Input placeholder="Tresting Standard"/>
</FormItem>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          special_testing_standard : item.special_testing_standard,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_special_testing setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default SpecialTestingStandard;
