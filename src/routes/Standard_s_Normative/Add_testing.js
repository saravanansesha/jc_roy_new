...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Testing Standard!\'}' }]} name={`testing_standard`}>

            <Input placeholder="Testing Standard"/>
    </FormItem>
