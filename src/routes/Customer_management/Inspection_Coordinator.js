...
// import BreadCrumb from "../../inspection_Coordinators/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_inspection_Coordinator from "./Add_inspection_Coordinator"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Inspection_Coordinator = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      inspection_Coordinator: 'inspection_Coordinatorss1',
      status: 'inactive',
    ...
    {
      key: '2',
      inspection_Coordinator: 'inspection_Coordinatorss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      inspection_Coordinator: 'inspection_Coordinatorss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      inspection_Coordinator: 'inspection_Coordinatorss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      inspection_Coordinator: 'inspection_Coordinatorss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      inspection_Coordinator: 'inspection_Coordinatorss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'inspection_Coordinator',
      key: 'inspection_Coordinator',
      ...
      if(check_presence.length > 0){
        ...
        values[`inspection_Coordinator${index}`] = value1[0].inspection_Coordinator
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.inspection_Coordinator = values[`inspection_Coordinator${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`inspection_Coordinator${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          inspection_Coordinator : item.inspection_Coordinator,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_inspection_Coordinator setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Inspection_Coordinator;
