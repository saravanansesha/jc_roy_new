...
// import BreadCrumb from "../../customer_Dispositions/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_customer_Disposition from "./Add_customer_Disposition"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Customer_Disposition = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      customer_Disposition: 'customer_Dispositionss1',
      status: 'inactive',
    ...
    {
      key: '2',
      customer_Disposition: 'customer_Dispositionss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      customer_Disposition: 'customer_Dispositionss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      customer_Disposition: 'customer_Dispositionss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      customer_Disposition: 'customer_Dispositionss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      customer_Disposition: 'customer_Dispositionss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'customer_Disposition',
      key: 'customer_Disposition',
      ...
      if(check_presence.length > 0){
        ...
        values[`customer_Disposition${index}`] = value1[0].customer_Disposition
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.customer_Disposition = values[`customer_Disposition${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`customer_Disposition${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          customer_Disposition : item.customer_Disposition,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_customer_Disposition setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Customer_Disposition;
