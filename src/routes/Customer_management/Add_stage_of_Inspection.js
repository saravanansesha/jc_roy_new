...
let Add_stage_of_Inspection = (props) =>{
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`stage_of_Inspection`}>
...
export default Add_stage_of_Inspection;