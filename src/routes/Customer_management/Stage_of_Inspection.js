...
// import BreadCrumb from "../../stage_of_Inspections/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_stage_of_Inspection from "./Add_stage_of_Inspection"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Stage_of_Inspection = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      stage_of_Inspection: 'stage_of_Inspectionss1',
      status: 'inactive',
    ...
    {
      key: '2',
      stage_of_Inspection: 'stage_of_Inspectionss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      stage_of_Inspection: 'stage_of_Inspectionss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      stage_of_Inspection: 'stage_of_Inspectionss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      stage_of_Inspection: 'stage_of_Inspectionss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      stage_of_Inspection: 'stage_of_Inspectionss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'stage_of_Inspection',
      key: 'stage_of_Inspection',
      ...
      if(check_presence.length > 0){
        ...
        values[`stage_of_Inspection${index}`] = value1[0].stage_of_Inspection
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.stage_of_Inspection = values[`stage_of_Inspection${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`stage_of_Inspection${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          stage_of_Inspection : item.stage_of_Inspection,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_stage_of_Inspection setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Stage_of_Inspection;
