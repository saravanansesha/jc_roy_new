...
let Add_inspection_Coordinator = (props) =>{
    ...
    return(
        <>
        <Modal
            title="Add Inspection Coordinator"
            footer={false}
            visible={isvisible}
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`inspection_Coordinator`}>
...
export default Add_inspection_Coordinator;