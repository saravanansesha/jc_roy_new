...
// import BreadCrumb from "../../nature_of_Complainss/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_nature_of_Complains from "./Add_nature_of_Complains"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Nature_of_Complains = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      nature_of_Complains: 'nature_of_Complainsss1',
      status: 'inactive',
    ...
    {
      key: '2',
      nature_of_Complains: 'nature_of_Complainsss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      nature_of_Complains: 'nature_of_Complainsss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      nature_of_Complains: 'nature_of_Complainsss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      nature_of_Complains: 'nature_of_Complainsss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      nature_of_Complains: 'nature_of_Complainsss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'nature_of_Complains',
      key: 'nature_of_Complains',
      ...
      if(check_presence.length > 0){
        ...
        values[`nature_of_Complains${index}`] = value1[0].nature_of_Complains
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.nature_of_Complains = values[`nature_of_Complains${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`nature_of_Complains${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          nature_of_Complains : item.nature_of_Complains,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_nature_of_Complains setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Nature_of_Complains;
