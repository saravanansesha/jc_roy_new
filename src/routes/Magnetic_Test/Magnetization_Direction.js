...
// import BreadCrumb from "../../magnetization_Directions/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_magnetization_Direction from "./Add_magnetization_Direction"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Magnetization_Direction = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      magnetization_Direction: 'magnetization_Directionss1',
      status: 'inactive',
    ...
    {
      key: '2',
      magnetization_Direction: 'magnetization_Directionss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      magnetization_Direction: 'magnetization_Directionss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      magnetization_Direction: 'magnetization_Directionss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      magnetization_Direction: 'magnetization_Directionss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      magnetization_Direction: 'magnetization_Directionss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'magnetization_Direction',
      key: 'magnetization_Direction',
      ...
      if(check_presence.length > 0){
        ...
        values[`magnetization_Direction${index}`] = value1[0].magnetization_Direction
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.magnetization_Direction = values[`magnetization_Direction${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`magnetization_Direction${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          magnetization_Direction : item.magnetization_Direction,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_magnetization_Direction setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Magnetization_Direction;
