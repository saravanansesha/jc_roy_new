...
// import BreadCrumb from "../../magnetization_Techniques/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_magnetization_Technique from "./Add_magnetization_Technique"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Magnetization_Technique = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      magnetization_Technique: 'magnetization_Techniquess1',
      status: 'inactive',
    ...
    {
      key: '2',
      magnetization_Technique: 'magnetization_Techniquess2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      magnetization_Technique: 'magnetization_Techniquess3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      magnetization_Technique: 'magnetization_Techniquess4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      magnetization_Technique: 'magnetization_Techniquess5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      magnetization_Technique: 'magnetization_Techniquess6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'magnetization_Technique',
      key: 'magnetization_Technique',
      ...
      if(check_presence.length > 0){
        ...
        values[`magnetization_Technique${index}`] = value1[0].magnetization_Technique
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.magnetization_Technique = values[`magnetization_Technique${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`magnetization_Technique${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          magnetization_Technique : item.magnetization_Technique,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_magnetization_Technique setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Magnetization_Technique;
