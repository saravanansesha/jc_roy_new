...
let Add_magnetization_Direction = (props) =>{
    ...
    return(
        <>
        <Modal
            title="Add Magnetization Direction"
            footer={false}
            visible={isvisible}
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`magnetization_Direction`}>
...
export default Add_magnetization_Direction;