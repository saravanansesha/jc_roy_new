...
// import BreadCrumb from "../../media_Applications/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_media_Application from "./Add_media_Application"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Media_Application = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      media_Application: 'media_Applicationss1',
      status: 'inactive',
    ...
    {
      key: '2',
      media_Application: 'media_Applicationss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      media_Application: 'media_Applicationss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      media_Application: 'media_Applicationss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      media_Application: 'media_Applicationss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      media_Application: 'media_Applicationss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'media_Application',
      key: 'media_Application',
      ...
      if(check_presence.length > 0){
        ...
        values[`media_Application${index}`] = value1[0].media_Application
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.media_Application = values[`media_Application${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`media_Application${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          media_Application : item.media_Application,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_media_Application setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Media_Application;
