...
let Add_magnetization_Technique = (props) =>{
    ...
    return(
        <>
        <Modal
            title="Add Magnetization Technique"
            footer={false}
            visible={isvisible}
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`magnetization_Technique`}>
...
export default Add_magnetization_Technique;