...
// import BreadCrumb from "../../particle_Colors/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_particle_Color from "./Add_particle_Color"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Particle_Color = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      particle_Color: 'particle_Colorss1',
      status: 'inactive',
    ...
    {
      key: '2',
      particle_Color: 'particle_Colorss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      particle_Color: 'particle_Colorss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      particle_Color: 'particle_Colorss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      particle_Color: 'particle_Colorss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      particle_Color: 'particle_Colorss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`particle_Color${index}`] = value1[0].particle_Color
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.particle_Color = values[`particle_Color${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`particle_Color${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          particle_Color : item.particle_Color,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_particle_Color setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Particle_Color;
