...
let Add_transfer_Correction = (props) =>{
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`transfer_Correction`}>
...
export default Add_transfer_Correction;