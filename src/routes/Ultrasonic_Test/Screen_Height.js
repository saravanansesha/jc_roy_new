...
// import BreadCrumb from "../../screen_Heights/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_screen_Height from "./Add_screen_Height"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Screen_Height = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      screen_Height: 'screen_Heightss1',
      status: 'inactive',
    ...
    {
      key: '2',
      screen_Height: 'screen_Heightss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      screen_Height: 'screen_Heightss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      screen_Height: 'screen_Heightss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      screen_Height: 'screen_Heightss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      screen_Height: 'screen_Heightss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`screen_Height${index}`] = value1[0].screen_Height
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.screen_Height = values[`screen_Height${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`screen_Height${index}`}>
...
<Add_screen_Height setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Screen_Height;
