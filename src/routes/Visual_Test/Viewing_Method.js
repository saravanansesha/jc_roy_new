...
// import BreadCrumb from "../../viewing_Methods/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_viewing_Method from "./Add_viewing_Method"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Viewing_Method = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      viewing_Method: 'viewing_Methodss1',
      status: 'inactive',
    ...
    {
      key: '2',
      viewing_Method: 'viewing_Methodss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      viewing_Method: 'viewing_Methodss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      viewing_Method: 'viewing_Methodss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      viewing_Method: 'viewing_Methodss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      viewing_Method: 'viewing_Methodss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`viewing_Method${index}`] = value1[0].viewing_Method
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.viewing_Method = values[`viewing_Method${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`viewing_Method${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          viewing_Method : item.viewing_Method,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_viewing_Method setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Viewing_Method;
