...
let Add_lighting_incidence = (props) =>{
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`lighting_incidence`}>
...
export default Add_lighting_incidence;