...
let Add_equipment_for_Renote_Vt = (props) =>{
    ...
    return(
        <>
        <Modal
            title="Add Equipment for Renote Vt"
            footer={false}
            visible={isvisible}
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`equipment_for_Renote_Vt`}>
...
export default Add_equipment_for_Renote_Vt;