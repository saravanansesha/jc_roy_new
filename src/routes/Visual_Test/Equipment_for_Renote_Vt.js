...
// import BreadCrumb from "../../equipment_for_Renote_Vts/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_equipment_for_Renote_Vt from "./Add_equipment_for_Renote_Vt"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Equipment_for_Renote_Vt = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      equipment_for_Renote_Vt: 'equipment_for_Renote_Vtss1',
      status: 'inactive',
    ...
    {
      key: '2',
      equipment_for_Renote_Vt: 'equipment_for_Renote_Vtss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      equipment_for_Renote_Vt: 'equipment_for_Renote_Vtss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      equipment_for_Renote_Vt: 'equipment_for_Renote_Vtss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      equipment_for_Renote_Vt: 'equipment_for_Renote_Vtss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      equipment_for_Renote_Vt: 'equipment_for_Renote_Vtss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'equipment_for_Renote_Vt',
      key: 'equipment_for_Renote_Vt',
      ...
      if(check_presence.length > 0){
        ...
        values[`equipment_for_Renote_Vt${index}`] = value1[0].equipment_for_Renote_Vt
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.equipment_for_Renote_Vt = values[`equipment_for_Renote_Vt${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`equipment_for_Renote_Vt${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          equipment_for_Renote_Vt : item.equipment_for_Renote_Vt,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_equipment_for_Renote_Vt setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Equipment_for_Renote_Vt;
