...
// import BreadCrumb from "../../aids_for_Direct_VTs/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_aids_for_Direct_VT from "./Add_aids_for_Direct_VT"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Aids_for_Direct_VT = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      aids_for_Direct_VT: 'aids_for_Direct_VTss1',
      status: 'inactive',
    ...
    {
      key: '2',
      aids_for_Direct_VT: 'aids_for_Direct_VTss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      aids_for_Direct_VT: 'aids_for_Direct_VTss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      aids_for_Direct_VT: 'aids_for_Direct_VTss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      aids_for_Direct_VT: 'aids_for_Direct_VTss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      aids_for_Direct_VT: 'aids_for_Direct_VTss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'aids_for_Direct_VT',
      key: 'aids_for_Direct_VT',
      ...
      if(check_presence.length > 0){
        ...
        values[`aids_for_Direct_VT${index}`] = value1[0].aids_for_Direct_VT
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.aids_for_Direct_VT = values[`aids_for_Direct_VT${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`aids_for_Direct_VT${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          aids_for_Direct_VT : item.aids_for_Direct_VT,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_aids_for_Direct_VT setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Aids_for_Direct_VT;
