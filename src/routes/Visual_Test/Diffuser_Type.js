...
// import BreadCrumb from "../../diffuser_Types/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_diffuser_Type from "./Add_diffuser_Type"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Diffuser_Type = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      diffuser_Type: 'diffuser_Typess1',
      status: 'inactive',
    ...
    {
      key: '2',
      diffuser_Type: 'diffuser_Typess2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      diffuser_Type: 'diffuser_Typess3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      diffuser_Type: 'diffuser_Typess4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      diffuser_Type: 'diffuser_Typess5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      diffuser_Type: 'diffuser_Typess6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`diffuser_Type${index}`] = value1[0].diffuser_Type
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.diffuser_Type = values[`diffuser_Type${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`diffuser_Type${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          diffuser_Type : item.diffuser_Type,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_diffuser_Type setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Diffuser_Type;