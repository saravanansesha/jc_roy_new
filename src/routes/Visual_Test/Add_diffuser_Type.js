...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`diffuser_Type`}>
...
export default Add_diffuser_Type;