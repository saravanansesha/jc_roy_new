...
let Add_aids_for_Direct_VT = (props) =>{
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`aids_for_Direct_VT`}>
...
export default Add_aids_for_Direct_VT;