...
// import BreadCrumb from "../../lighting_incidences/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_lighting_incidence from "./Add_lighting_incidence"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Lighting_incidence = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      lighting_incidence: 'lighting_incidencess1',
      status: 'inactive',
    ...
    {
      key: '2',
      lighting_incidence: 'lighting_incidencess2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      lighting_incidence: 'lighting_incidencess3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      lighting_incidence: 'lighting_incidencess4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      lighting_incidence: 'lighting_incidencess5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      lighting_incidence: 'lighting_incidencess6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'lighting_incidence',
      key: 'lighting_incidence',
      ...
      if(check_presence.length > 0){
        ...
        values[`lighting_incidence${index}`] = value1[0].lighting_incidence
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.lighting_incidence = values[`lighting_incidence${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`lighting_incidence${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          lighting_incidence : item.lighting_incidence,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_lighting_incidence setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Lighting_incidence;