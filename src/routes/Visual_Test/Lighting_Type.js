...
// import BreadCrumb from "../../lighting_Types/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_lighting_Type from "./Add_lighting_Type"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Lighting_Type = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      lighting_Type: 'lighting_Typess1',
      status: 'inactive',
    ...
    {
      key: '2',
      lighting_Type: 'lighting_Typess2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      lighting_Type: 'lighting_Typess3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      lighting_Type: 'lighting_Typess4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      lighting_Type: 'lighting_Typess5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      lighting_Type: 'lighting_Typess6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`lighting_Type${index}`] = value1[0].lighting_Type
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.lighting_Type = values[`lighting_Type${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`lighting_Type${index}`}>
...
<Add_lighting_Type setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Lighting_Type;
