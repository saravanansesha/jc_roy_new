...
// import BreadCrumb from "../../lighting_Sources/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_lighting_Source from "./Add_lighting_Source"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Lighting_Source = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      lighting_Source: 'lighting_Sourcess1',
      status: 'inactive',
    ...
    {
      key: '2',
      lighting_Source: 'lighting_Sourcess2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      lighting_Source: 'lighting_Sourcess3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      lighting_Source: 'lighting_Sourcess4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      lighting_Source: 'lighting_Sourcess5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      lighting_Source: 'lighting_Sourcess6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`lighting_Source${index}`] = value1[0].lighting_Source
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.lighting_Source = values[`lighting_Source${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`lighting_Source${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          lighting_Source : item.lighting_Source,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_lighting_Source setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Lighting_Source;
