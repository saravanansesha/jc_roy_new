...
// import BreadCrumb from "../../action_Categorys/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_action_Category from "./Add_action_Category"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Action_Category = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      action_Category: 'action_Categoryss1',
      status: 'inactive',
    ...
    {
      key: '2',
      action_Category: 'action_Categoryss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      action_Category: 'action_Categoryss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      action_Category: 'action_Categoryss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      action_Category: 'action_Categoryss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      action_Category: 'action_Categoryss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`action_Category${index}`] = value1[0].action_Category
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.action_Category = values[`action_Category${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`action_Category${index}`}>
...
<Add_action_Category setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Action_Category;
