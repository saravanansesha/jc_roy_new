...
let Add_nature_Of_Observation = (props) =>{
    ...
    return(
        <>
        <Modal
            title="Add Nature Of Observation"
            footer={false}
            visible={isvisible}
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`nature_Of_Observation`}>
...
export default Add_nature_Of_Observation;   