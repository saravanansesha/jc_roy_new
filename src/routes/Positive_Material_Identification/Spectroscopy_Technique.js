...
// import BreadCrumb from "../../spectroscopy_Techniques/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_spectroscopy_Technique from "./Add_spectroscopy_Technique"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Spectroscopy_Technique = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      spectroscopy_Technique: 'spectroscopy_Techniquess1',
      status: 'inactive',
    ...
    {
      key: '2',
      spectroscopy_Technique: 'spectroscopy_Techniquess2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      spectroscopy_Technique: 'spectroscopy_Techniquess3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      spectroscopy_Technique: 'spectroscopy_Techniquess4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      spectroscopy_Technique: 'spectroscopy_Techniquess5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      spectroscopy_Technique: 'spectroscopy_Techniquess6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      title: 'Title',
      dataIndex: 'spectroscopy_Technique',
      key: 'spectroscopy_Technique',
      ...
      if(check_presence.length > 0){
        ...
        values[`spectroscopy_Technique${index}`] = value1[0].spectroscopy_Technique
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.spectroscopy_Technique = values[`spectroscopy_Technique${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`spectroscopy_Technique${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          spectroscopy_Technique : item.spectroscopy_Technique,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_spectroscopy_Technique setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Spectroscopy_Technique;
