...
// import BreadCrumb from "../../reading_Done_Ons/BreadCrumbs"
// import Setproductadd from "./Setproductadd"
import Add_reading_Done_On from "./Add_reading_Done_On"
// const DesignStandard = Tabs.TabPane;
const {Option, OptGroup} = Select;
const FormItem = Form.Item;
const Reading_Done_On = ({match}) => {
  ...
  const [data_back,setdata] = useState([
    {
      key: '1',
      reading_Done_On: 'reading_Done_Onss1',
      status: 'inactive',
    ...
    {
      key: '2',
      reading_Done_On: 'reading_Done_Onss2',
      status: 'active',
      permissions : 'permissions',
      action : <div>
      <button>
    ...
    },
    {
      key: '3',
      status: 'active',
      reading_Done_On: 'reading_Done_Onss3',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    },
    {
      key: '4',
      status: 'active',
      reading_Done_On: 'reading_Done_Onss4',
      permissions : 'permissions',
      action : <div>
        <button>
            Edit
    ...
    {
      key: '5',
      reading_Done_On: 'reading_Done_Onss5',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
    ...
    {
      key: '6',
      reading_Done_On: 'reading_Done_Onss6',
      status: 'active',
      permissions : 'permissions',
      action : <div>
        <button>
  ...
  const columns = [
    {
      ...
      if(check_presence.length > 0){
        ...
        values[`reading_Done_On${index}`] = value1[0].reading_Done_On
        ...
        function onFinish(values){
          let datason = data_back.map((item)=>{
            if(item.key == find_key){
              ...
              forchange.reading_Done_On = values[`reading_Done_On${index}`]
        ...
        function onFinishFailed(){
          ...
          layout="inline">
                     <FormItem label={`Title`} rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`reading_Done_On${index}`}>
    ...
    let check_presence =   foredit.filter((items)=>{    
      ...
      if(check_presence.length > 0){
        ...
        return {
          ...
          key : item.key,
          reading_Done_On : item.reading_Done_On,
          created : '06-09-2022',
          modified : '07-09-2022',
...
<Add_reading_Done_On setvisible={setvisible} isvisible={isvisible} />
{/* <Setproductadd setvisible={setvisible} isvisible={isvisible} /> */}
    </div>
  );
};
    
export default Reading_Done_On;
