...
let Add_spectroscopy_Technique = (props) =>{
...
onFinish={onFinish}
layout="inline">
    <FormItem  rules={[{ required: true, message: 'Please input your Title!\'}' }]} name={`spectroscopy_Technique`}>
...
export default Add_spectroscopy_Technique;